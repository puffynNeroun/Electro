                ...
                <div id="top-header">
                    <div className="container">
                        <ul className="header-links pull-left">
                            ...
                            <li><a href="#"><FontAwesomeIcon className="fa fa-envelope-open-o" icon={faEnvelopeOpen} /> email@email.com</a></li>
                            <li><a href="#"><FontAwesomeIcon className='fa fa-dollar' icon={faDollar} /> 1734 Stonecoal Road</a></li>
                        </ul>
